...
var ASM_CONSTS = {
  67960: () => { console.log(22); testReturn(); }
};
...
// end include: preamble.js
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(4, 1, fd, iov, iovcnt, pnum);
...
/** @type {function(...*):?} */
var _testThread = Module["_testThread"] = createExportWrapper("testThread");
/** @type {function(...*):?} */
var _testThread2 = Module["_testThread2"] = createExportWrapper("testThread2");
/** @type {function(...*):?} */
var _testThread3 = Module["_testThread3"] = createExportWrapper("testThread3");
/** @type {function(...*):?} */
