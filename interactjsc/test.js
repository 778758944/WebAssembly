...
var real___Z10daysInWeekv = asm["__Z10daysInWeekv"]; asm["__Z10daysInWeekv"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___Z10daysInWeekv.apply(null, arguments);
};
...
Module["asm"] = asm;
var __Z10daysInWeekv = Module["__Z10daysInWeekv"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__Z10daysInWeekv"].apply(null, arguments) };
